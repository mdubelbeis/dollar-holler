...
<header class="col-span-3 bg-daisyBush text-center">
	...
	<nav>
		<ul class="list-none text-2xl font-bold">
			...
			<li>
				<a class:active={$page.url.pathname === '/client'} href="/client">Clients</a>
			</li>
			<li>
				<a class:active={$page.url.pathname === '/settings'} href="#">Settings</a>
			</li>
			<li>
				<a class:active={$page.url.pathname === '/logout'} href="#">Logout</a>
			</li>
		</ul>
	</nav>
</header>
